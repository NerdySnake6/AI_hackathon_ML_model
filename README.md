...
Основная точка входа находится в классе `PredictionModel` в [solution.py](solution.py).
...
- [solution.py](solution.py): инференс и класс `PredictionModel`
- [train.py](train.py): обучение и генерация артефактов
- [typequery_classifier.py](typequery_classifier.py): модель `TypeQuery`
- [title_retrieval.py](title_retrieval.py): retrieval для названий
- [franchise_dict.py](franchise_dict.py): словарный матчинг
- [embeddings.py](embeddings.py): векторизация и индекс эмбеддингов
- [knowledge_graph.py](knowledge_graph.py): графовые признаки и матчинги
- [aggregator.py](aggregator.py): объединение сигналов
- [scripts/eval_hidden_like.py](scripts/eval_hidden_like.py): локальная hidden-like оценка
